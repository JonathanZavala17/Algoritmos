...
//Setea el tamaño de la fotografia y mantiene la proporcionalidad 
...
void display()
{
    ...
    glLoadIdentity();
    //Posiciona la camara en la cara delantera
    gluLookAt (0.15, 0.150, 0.212, 0.15, 0.15, -0.3, 0.0, 3.0, 6.0);
